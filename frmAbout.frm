...
Begin VB.Form frmAbout 
   ...
   BackColor       =   &H80000005&
   BorderStyle     =   0  'None
   Caption         =   "About the Program and the Author"
   ClientHeight    =   5400
   ClientLeft      =   3855
   ClientTop       =   3990
   ClientWidth     =   8250
...
' First set this option so that we need to declare
Option Explicit
...
Private Sub Form_Load()
  ...
  Call Shell(App.Path & "\aboutme.exe", vbNormalFocus)
  
  ' Assign the exe file to our variable
  ProjectIntro = FindWindow(vbNullString, "About Me and the Program")
